    ...
    return (
        <div className="relative w-full flex flex-col justify-center items-center mt-[100px]">
            <div className="w-full text-center flex flex-col gap-[16px] items-center justify-center">
                <h1 className="text-[#D1DBE0] text-[48px] font-[400]"><span className="text-[#2EEA90]">$TPAD</span> Tokenomics</h1>
                <p className="w-[40%] flex text-[#D1DBE08C]">We started our launch with 1,000,000 tokens, approximately 350,000 of
            ...
            <div className="relative flex flex-col justify-center items-center w-full h-full z-[99] ">
                ...
                <div className="">
                    <div className="flex flex-col gap-[-5px] absolute top-[28%] left-[14%] text-right">
                        <h1 className="text-[#D1DBE0] text-[20px]">1 000 000</h1>
                    ...
                    <div className="flex flex-col gap-[-5px] absolute top-[28%] right-[19%] text-left">
                        <h1 className="text-[#D1DBE0] text-[20px]">5%</h1>
                        <p className="text-[#D1DBE08C] text-[14px]">Buy Tax</p>
                    </div>
                </div>
                <div className="">
                    <div className="flex flex-col gap-[-5px] absolute top-[45.6%] left-[8%] text-right">
                        <h1 className="text-[#D1DBE0] text-[20px]">350 000</h1>
                    ...
                    <div className="flex flex-col gap-[-5px] absolute top-[45.6%] right-[8%] text-left">
                        <h1 className="text-[#D1DBE0] text-[20px]">Task Of Taxes</h1>
                        <p className="text-[#D1DBE08C] text-[14px]">For buybacks, liquidity etc. </p>
                    </div>
                </div>
                <div className="">
                    <div className="flex flex-col gap-[-5px] absolute bottom-[30%] left-[14%] text-right">
                        <h1 className="text-[#D1DBE0] text-[20px]">650 000</h1>
                    ...
                    <div className="flex flex-col gap-[-5px] absolute bottom-[30%] right-[19%] text-left">
                        <h1 className="text-[#D1DBE0] text-[20px]">5%</h1>
                        <p className="text-[#D1DBE08C] text-[14px]">Sell Tax</p>
                    </div>
                </div>
