...
export const LaunchpadCard: React.FC<LaunchPadCardDetailsProps> = ({ imageName, heading, content }) => {
    return (
        <div className="relative z-[3] w-full h-full py-[20px] overflow-hidden rounded-[8px] px-[24px] border-[1px] border-[#1A1A1A] bg-no-repeat bg-cover bg-[url('/images/presale_card_bg.svg')]">
            <div className="h-full w-full" >
                <div className={`absolute top-[0px] left-[-2px] h-full w-full z-[-5] bg-[url(/images/${imageName})] bg-no-repeat bg-contain`} />
